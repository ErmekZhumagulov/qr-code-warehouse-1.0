...
def show_report_popup():
    ...
    note_label_1 = QLabel("(Внимание: при отправке отчета на почту отображаемые запчасти переносятся")
    note_label_2 = QLabel("          в архивный файл, и они больше не будут отображаться в истории)")
